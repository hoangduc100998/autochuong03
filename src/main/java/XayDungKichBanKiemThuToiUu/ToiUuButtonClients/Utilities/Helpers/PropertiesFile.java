package XayDungKichBanKiemThuToiUu.ToiUuButtonClients.Utilities.Helpers;
...
public class PropertiesFile {
    ...
    private static String propertiesFilePathRoot = "src/test/java/TT_Client/TestData/configs.properties";
