package FaceBook.CheckPage.Actions.commons;
...
//    }
    ...
    public String clickToElement(WebDriver driver, String xpathExpression){
    ...
    public void sendKeyToElement2(WebDriver driver, String xpathExpression, String value) {
        // Áp dụng textbox, textarea, dropdown list, upload file
        // driver.findElement(By.xpath(xpathExpression)).clear();
        // driver.findElement(By.xpath(xpathExpression)).sendKeys(value);
        WebElement element = getElement(driver, xpathExpression);
        element.clear();
        element.sendKeys(Keys.COMMAND + "a"); // Select all text
