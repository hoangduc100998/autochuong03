package AutomationWebFramework.ThucHanh2.Actions.commons;
...
//                break;
    ...
    private WebDriver initChromeDriverExe(String appURL) {
        ...
        System.setProperty("webdriver.chrome.driver",projectPath +
                "src/main/java/AutomationWebFramework/ThucHanh2/Resoure/chromedriver");
        driver=new ChromeDriver();
        driver.manage().window().maximize();
        driver.get(appURL);
        driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
    ...
    private WebDriver initFirefoxDriverExe(String appURL) {
        ...
        System.setProperty("webdriver.gecko.driver",projectPath +
                "src/main/java/AutomationWebFramework/ThucHanh2/Resoure/geckodriver");
        driver=new FirefoxDriver();
        driver.manage().window().maximize();
        driver.get(appURL);
        driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
